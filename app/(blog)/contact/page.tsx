...
const Contact = () => {
  return (
    <div>
      <section className='border max-w-lg mx-auto my-20 p-8 bg-slate-400 shadow-md rounded-md'>
        ...
        <form>
          ...
          <button type='submit' className='w-full bg-black text-white hover:text-orange-600 py-2 rounded-md'>Send Message</button>
        </form>
      </section>
    </div>
  )
